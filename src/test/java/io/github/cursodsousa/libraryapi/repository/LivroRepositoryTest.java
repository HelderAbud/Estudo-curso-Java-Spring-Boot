...
class LivroRepositoryTest {
    ...
    void salvarTest(){
        ...
        Autor autor = autorRepository
                ...
                .orElseGet(() -> {
                    ...
                    maria.setId(UUID.fromString("76e7c418-ccf9-4e2a-af20-c28b9e50ab55"));
                    maria.setNome("Maria");
                    maria.setNacionalidade("Brasileira");
                    maria.setDataNascimento(LocalDate.of(1951, 1, 31));
                    return autorRepository.save(maria);
                });
    ...
    void atualizarAutorDoLivro(){
        ...
        autorOriginal.setNome("Carlos");
        autorOriginal.setNacionalidade("Brasileira");
        autorOriginal.setDataNascimento(LocalDate.of(1951, 1, 31));
        autorRepository.save(autorOriginal);

        Livro livroParaAtualizar = new Livro();
        livroParaAtualizar.setId(UUID.fromString("cfbc87ce-5932-4792-bff0-78ef5973861b"));
        livroParaAtualizar.setIsbn("11111-11111");
        livroParaAtualizar.setPreco(BigDecimal.valueOf(50));
        livroParaAtualizar.setGenero(GeneroLivro.FICCAO);
        livroParaAtualizar.setTitulo("Livro para atualizar autor");
        livroParaAtualizar.setDataPublicacao(LocalDate.of(1990, 5, 10));
        livroParaAtualizar.setAutor(autorOriginal);
        ...
        Autor maria = autorRepository
                ...
                .orElseGet(() -> {
                    Autor autor = new Autor();
                    autor.setId(UUID.fromString("76e7c418-ccf9-4e2a-af20-c28b9e50ab55"));
                    autor.setNome("Maria");
                    autor.setNacionalidade("Brasileira");
                    autor.setDataNascimento(LocalDate.of(1951, 1, 31));
